...
const About = () => {
    return (
        <div className="max-w-[800px] px-2 container mx-auto flex-col">
            ...
            <div className="pb-20">
                <motion.h1
                    className='text-lightgray md:text-6xl text-[30px] mb-8'
