    ...
    return (
        <section className='dark:bg-dark bg-light py-[20px] '>
            <div className="max-w-[800px] px-2 container mx-auto flex-col">
                <div className="flex items-center justify-center h-[450px] relative mt-10">
                    <div className="">
                        <Scene />
                    </div>
                </div>
                <div className="text-secondary-200 px-6">
                    <h1 className='text-lightgray text-6xl mb-8'>Crafting Exceptional User Experiences: <span className='text-secondary-200'>About Me</span></h1>
