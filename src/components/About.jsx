    ...
    return (
        <section className='dark:bg-dark bg-light py-[20px] '>
            <motion.div
                ...
                className="max-w-[800px] px-2 container mx-auto flex-col"
            >
